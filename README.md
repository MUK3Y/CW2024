...
**4. Implemented but not Working Properly**
  ...
  **6. New Java Classes**
    ...
    6.4. MainMenu.fxml (Not a class, but required)
        6.4.1. The file formats the mainmenu page in the game, mainly coded by SceneBuilder.

    6.5. MainMenu.css (Not a class, but required)
        6.5.1. Formats the background image for main menu.
